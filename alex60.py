...
def check_password():
    if "password_correct" not in st.session_state:
        st.markdown("<h2 style='text-align: center; color: #f1c40f;'>☀️ PV Alex Balkonkraftwerk 60°</h2>", unsafe_allow_html=True)
...
configs = [
    {"name": "Balkon", "lat": 49.482869333, "lon": 8.2741404808, "wp": 475, "num": 2, "tilt": 60, "azi": 185, "color": "#f1c40f", "shade": None},
{"name": "Balkon Wand", "lat": 49.482869333, "lon": 8.2741404808, "wp": 475, "num": 2, "tilt": 90, "azi": 185, "color": "#f1c40f", "shade": None}]
